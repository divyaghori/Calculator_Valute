...
import com.example.calculatorhide.Activity.ImportAudioActivity;
...
public class AdapterFilesHolderAudio extends RecyclerView.Adapter<AdapterFilesHolderAudio.AdapterViewHolder> implements Filterable {
    private Filter MyFilesFilter = new Filter() { // from class: example.own.allofficefilereader.adapters.AdapterFilesHolder.1
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence == null || charSequence.length() == 0) {
                arrayList.addAll(AdapterFilesHolderAudio.this.tempList);
            } else {
                String trim = charSequence.toString().toLowerCase().trim();
                Iterator<ModelFilesHolder> it2 = AdapterFilesHolderAudio.this.tempList.iterator();
                while (it2.hasNext()) {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            AdapterFilesHolderAudio.this.itemsList.clear();
            AdapterFilesHolderAudio.this.itemsList.addAll((List) filterResults.values);
            AdapterFilesHolderAudio.this.notifyDataSetChanged();
        }
    };
    SparseBooleanArray mSparseBooleanArray;
    ImportAudioActivity activityFilesHolder;
    Context context;
    ArrayList<ModelFilesHolder> itemsList;
    ArrayList<ModelFilesHolder> tempList;

    public AdapterFilesHolderAudio(Context context, ImportAudioActivity activityFilesHolder, ArrayList<ModelFilesHolder> arrayList) {
